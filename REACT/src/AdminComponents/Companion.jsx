...
const Companion = () => {
  ...
  const goBack = () => console.log("Going back");
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="block">
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm text-white">
                  {companionDetails.length} records
                </span>
              </div>
            </div>
          </div>
              ...
              {companionDetails.map((c, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-black text-white text-sm font-bold">
                      {index + 1}
                    </div>
